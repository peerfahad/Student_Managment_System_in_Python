...
class student:
    def __init__(self, root):
      ...
      title = Label(self.root, text="Student Managemnt System", bd=10, relief=GROOVE, font=(
          "time new roman", 40, "bold"), bg="yellow", fg="red")
      ...
      lbl_search = Label(detail_frame, text="Search By", font=(
          "time new roman", 20, "bold"), bg="crimson", fg="white")
      ...
      txt_search = Entry(detail_frame, width=20, font=(
          "time new roman", 10, "bold"), bd=5, relief=GROOVE)
      txt_search.grid(row=0, column=2, pady=10, padx=20, sticky="w")

      searchbtn = Button(detail_frame, text="Search", width=10, pady=5).grid(
          row=0, column=3, padx=10, pady=10)
      showallbtn = Button(detail_frame, text="Show all", width=10, pady=5).grid(
      ...
      self.student_table = ttk.Treeview(table_frame, columns=(
          "roll", "name", "email", "gender", "contact", "dob", "address"), xscrollcommand=scroll_x.set, yscrollcommand=scroll_y)
